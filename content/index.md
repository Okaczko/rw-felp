...
- "This isn't a puzzle game, it's an environmental sandbox sim. There IS a story and an end but the main core of the gameplay is you're in a world and you can explore and interact with it as you wish. The only mandated barebones information to beat the game was taught in the very start - how to move and eat and shelter - and everything else is for you to discover and tinker, optionally. So don't fuss about overarching goals. Right now the goal is to immerse yourself into this little creature. All you have to think about right now is live another day and find out more about the world. And proper info will, eventually, find its way to you." - **Sarcruromolfeus**
...
- First ask what the player knows about them, avoid telling them anything more that could be a spoiler. It’s unlikely for players to find Inv without outside input, and meant to be found by solving a riddle from the RW community.
	...
	- *The one made by felpers (better imo. Give the orignal first tho and let them decide):*
		`The bottom of the top, an oasis in the desert`
...
- The problem arises when it's a first playthrough without MSC (MSC adds 2 grapple worms to the western side of Underhang, making it possible to get quickly to FP), because then they would have to go to Shaded, Leg, Underhang and FP. That can be an insane backtrack. I'm on the "you should explore the parts you haven't been to yet" but that can be frustrating to the player. Thing is, this happens mainly on playthroughs where the player kills LTTM, because the overseer prefers the Shaded>Leg>Underhang route and stays there for most of the time, while void spawn are mainly present in Shaded and Shoreline (they do point you to Memory Crypts). Figuring out without the help of overseers on how to get to Five Pebbles from the Underhang could be a big hassle. Observe how the player acts, most often I just tell them that there are other ways to get there and to explore the paths they haven't taken yet (That is _my_ approach however, do as you find ideal)
