...
- The problem arises when it's a first playthrough without MSC (MSC adds 2 grapple worms to the western side of Underhang, making it possible to get quickly to FP), because then they would have to go to Shaded, Leg, Underhang and FP. That can be an insane backtrack. I'm on the "you should explore the parts you haven't been to yet" but that can be frustrating to the player. Thing is, this happens mainly on playthroughs where the player kills LTTM, because the overseer prefers the Shaded>Leg>Underhang route. Figuring out without the help of overseers on how to get to Five Pebbles from the Underhang could be a big hassle. Observe how the player acts, most oftenly I just tell them that there are other ways to get there and to explore the paths they haven't taken yet (That is _my_ approach however, do as you find ideal)
